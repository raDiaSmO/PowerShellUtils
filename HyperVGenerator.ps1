#Function to automate the deployment of virtual machines.
...
New-Item -ItemType Directory "$($WorkingDirectory)" -Force
    ...
    try {
        #Divide to convert the strings from the paremeters to Uint64. (https://stackoverflow.com/questions/41088561/how-to-convert-to-uint64-from-a-string-in-powershell-string-to-number-conversio)
        ...
        Write-Warning -Message "Could not process the request."
        break
    }
}
