#Function to gather multiple hash values (MD5 and SHA1) from a given path of files. Especially useful for forensic purposes.
...
[CmdletBinding()]
    ...
    try {
        ...
        Write-Warning -Message "Could not analyze the files."
        break
    }
}
